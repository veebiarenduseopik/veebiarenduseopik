...
let config = {
    ...
    BLOOM_THRESHOLD: 0.6,
    BLOOM_SOFT_KNEE: 0.7,
    POINTER_COLOR: [{ r: 0.245, g: 0.122, b: 0.121 }],
...
let ditheringTexture = createTextureAsync('media/img/LDR_RGB1_0.png');
...
window.addEventListener('mousemove', e => {
    if (!config.SHOW_MOUSE_MOVEMENT || window.innerWidth <= 767) return;
